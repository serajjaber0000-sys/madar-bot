        ...
        <div class="lp-hero-inner">
          <div class="lp-hero-card">
            <div class="lp-hero-badge">
              ...
              للitched فقط — يرجى الاتصال للحجز
            </div>
      ...
      <div class="lp-body">
        ...
        <div class="lp-subscribe-cta">
          <div class="lp-cta-icon">
            <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="#fff" stroke-width="2"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/></svg>
          </div>
          <h3>أنت طبيب وتريد الانضمام؟</h3>
          <p>سجّل عيادتك الآن واستفد من الحجز الإلكتروني وإدارة المرضى</p>
          <a href="https://asaasedu.com/login" target="_blank" class="lp-cta-btn">سجّل الآن مجاناً</a>
        </div>
      </div>
    </template>
  </div>
...
.lp-cta-btn{display:inline-block;padding:12px 32px;border-radius:12px;background:#fff;color:#0d9488;font-weight:800;font-size:0.88rem;text-decoration:none;transition:all 0.2s}

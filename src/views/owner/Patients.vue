...
<style scoped>
.view-patient-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 16px; }
.view-patient-item { display: flex; flex-direction: column; gap: 5px; background: #f8fafc; border: 1px solid #e5e7eb; border-radius: 10px; padding: 12px 14px; }
.view-patient-item-full { grid-column: 1 / -1; }
.view-patient-label { font-size: 0.72rem; font-weight: 700; color: #64748b; }
.view-patient-value { font-size: 0.9rem; font-weight: 700; color: #1e293b; word-break: break-word; }
.report-patient-bar { display: flex; flex-wrap: wrap; gap: 24px; background: #fff; border: 1px solid #e5e7eb; border-radius: 14px; padding: 16px 20px; margin-bottom: 16px; }
.report-patient-item { display: flex; flex-direction: column; gap: 4px; }
.report-patient-label { font-size: 0.72rem; font-weight: 700; color: #64748b; }
.report-patient-value { font-size: 1rem; font-weight: 800; color: #1e293b; }
.report-body-card { padding: 4px; }
.report-textarea { width: 100%; min-height: 420px; border: none; border-radius: 14px; padding: 18px; font-size: 0.95rem; font-weight: 600; line-height: 1.8; color: #1e293b; background: #fff; resize: vertical; outline: none; }
.report-textarea:disabled { background: #f8fafc; color: #64748b; cursor: not-allowed; }
.report-textarea:focus:not(:disabled) { box-shadow: inset 0 0 0 2px #1150c9; }

/* ===== Mobile cards ===== */
.patient-mobile-card { display: none; }

@media (max-width: 768px) {
  .report-patient-bar { gap: 14px; padding: 12px 14px; }
  .report-textarea { min-height: 200px; }
...
@media (max-width: 480px) {
  .view-patient-grid { grid-template-columns: 1fr; }
